...
#some graphical magic to visualize data
    def printGraph(self, csvData):
        ...
        explode=(0, 0, 0, 0, 0, 0)
        del csvData[-1]
        ax.pie(csvData, explode=explode, labels=labels, autopct='%1.1f%%', shadow=True)
        ax.set_title('', bbox={'facecolor':'0.8', 'pad':5})
